		...
		return queryInterface.bulkInsert('class', [
			{
				...
				deskripsi:
					'Fullstack Batch 5 adalah Pelatihan untuk Seseorang yang akan menjadi Seorang Fullstack Developer'
			},
			{
				id: 2,
				...
				deskripsi:
					'Fullstack Batch 6 adalah Pelatihan untuk Seseorang yang akan menjadi Seorang Fullstack Developer'
			},
			{
				id: 3,
